...
const Facilities = () => {
    ...
    const galleryImages = [
        { src: logo, alt: 'Smart Classroom', span: 2, height: 2 },
        { src: logo, alt: 'Study Area', span: 1, height: 1 },
        { src: logo, alt: 'Library', span: 1, height: 1 },
        { src: logo, alt: 'Break Area', span: 1, height: 2 },
        { src: logo, alt: 'Computer Lab', span: 2, height: 1 },
        { src: logo, alt: 'Training Room', span: 1, height: 1 },
        { src: logo, alt: 'Workspace', span: 1, height: 1 },
        { src: logo, alt: 'Conference Room', span: 2, height: 1 },
        { src: logo, alt: 'Workspace', span: 1, height: 1 },
